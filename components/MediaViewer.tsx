      ...
      <div className="canvas-lightbox canvas-media-viewer media-viewer-shared">
        <header>
          ...
          <div className="media-viewer-header-actions">
            ...
            {onAngle && item.kind === "image" && <button type="button" className="media-viewer-header-button media-viewer-panorama-button" onClick={onAngle} title="打开真实360°球体查看器"><span className="media-viewer-button-icon" aria-hidden="true">◌</span><span>360°查看</span></button>}
