...
test("centers the toolbar and editor on the selected card", () => {
...
test("keeps both overlays inside a narrow stage without side placement", () => {
  ...
  assert.deepEqual(toolbar, { left: 10, top: 10 });
  assert.deepEqual(editor, { left: 10, top: 10 });
  assert.ok(editor.top >= 0);
});
