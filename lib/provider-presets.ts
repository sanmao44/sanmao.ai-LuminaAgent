...
export const providerPresets: ProviderPreset[] = [
  ...
  { value: 'siliconflow', label: '硅基流动 SiliconFlow', short: '硅基流动', description: '国内兼容平台，地址已内置', logo: '/brand/providers/siliconflow.ico', type: 'openai-compatible', baseUrl: 'https://api.siliconflow.cn/v1', needsBaseUrl: false, apiKeyUrl: 'https://cloud.siliconflow.cn/account/ak', notice: '有免费额度，可先体验', noticeTone: 'success' },
  { value: 'gitee', label: 'Gitee 模力方舟', short: '模力方舟', description: '国内兼容平台，含 GLM-TTS / CosyVoice 等语音合成模型，地址已内置', logo: '/brand/providers/gitee.svg', type: 'openai-compatible', baseUrl: 'https://ai.gitee.com/v1', needsBaseUrl: false, apiKeyUrl: 'https://ai.gitee.com/serverless-api', notice: '有免费调用额度，可先体验', noticeTone: 'success' },
